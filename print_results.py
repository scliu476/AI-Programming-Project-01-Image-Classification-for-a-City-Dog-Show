    ...
    if print_incorrect_dogs and results_stats_dic['n_correct_dogs'] + results_stats_dic['n_correct_notdogs'] != results_stats_dic['n_images']:
        for key in results_dic.keys():
            if sum(results_dic[key][3:]) == 1:
                print('Misclassified Dogs: [{}] is classified as [{}]'.format(results_dic[key][0],results_dic[key][1]))
        
    if print_incorrect_breed and results_stats_dic['n_correct_dogs'] != results_stats_dic['n_correct_breed']:
        for key in results_dic.keys():
            if sum(results_dic[key][3:]) == 2 and results_dic[key][2] == 0:
                print("Misclassified Breed's of Dog: [{}] is classified as [{}]".format(results_dic[key][0],results_dic[key][1]))    
    print('------------------------------------------------------------------------------------------------------------')               