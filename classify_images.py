...
def classify_images(images_dir, results_dic, model):
    ...
    """
    for result_key in results_dic.keys():
        pet_label = results_dic[result_key][0]
        classifier_label = classifier(images_dir + result_key, model).lower()
        ...
        # Populates dictionary with whether or not labels indicate a dog image
        results_dic[result_key] = [pet_label, classifier_label, match]
